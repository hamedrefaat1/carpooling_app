                ...
                child: Column(
                  children: [
                    ...
                    _UserTypeCard(
                      ...
                      onTap: () {
                         context.read<Usersetupcubit>().requestLocationAndSetup("driver");
                      },
                    ),
                    ...
                    _UserTypeCard(
                      ...
                      onTap: () {
                      context.read<Usersetupcubit>().requestLocationAndSetup("Passenger");
                      },
                    ),
                  ],
                ),
...
class _UserTypeCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      onTap: onTap,
      child: BlocListener<Usersetupcubit, UserSetupStates>(
